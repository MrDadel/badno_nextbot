...
ENT.PrintName = "Badno"
ENT.Spawnable = false
list.Set( "NPC", "terminator_nextbot_badno", {
    Name = "Badno",
    Class = "terminator_nextbot_badno",
...
if CLIENT then
    language.Add( "terminator_nextbot_badno", ENT.PrintName )

    local contentVar = GetConVar( "badno_dynamic_content" )
    local gotBOTContent
    local gotPMContent
    local attempts = 0
...
local JERMINATOR_MODEL = "models/player/mrdashell/badno.mdl"
ENT.Models = { BADNO_MODEL }
